...
class Ui_viewHistory(object):
    ...
    def retranslateUi(self, viewHistory):
        ...
        self.gameNoLabel.setText(_translate("viewHistory", "1"))
        self.labelWhite.setText(_translate("viewHistory", "White Player:"))
        self.whitePlayerLabel.setText(_translate("viewHistory", "Player 1"))
        self.labelBlack.setText(_translate("viewHistory", "Black Player:"))
        self.blackPlayerLabel.setText(_translate("viewHistory", "Player 2"))
        self.labelDate.setText(_translate("viewHistory", "Date: 2023-11-15"))
